...
現在のところVIAやReMapなどにはマージされていません。RESETボタンを押しながらPCとRP2040-Zeroを接続し、ストレージとして認識されたら.uf2ファイルをコピーします。  
...
### LEDのはんだづけ(任意)
![16,777,216色に光ります(所説あり)](img/led.jpg)
...
<details><summary>列単位でキーが反応しない</summary>Pro Microのピンソケット・ピンヘッダのはんだ不良を疑います。</details>
<details><summary>LEDが全部光らない</summary>初期ファームウェアでは左上5キーの一番右がLEDのオンオフに割り当てられています。一度押してみて、光らない場合ははんだ側の問題です。LEDに割り当てられているPro MicroのピンはVCC/GND/　として表示されているので、この部分と、L1のはんだを確認してください。</details>
<details><summary>LEDが途中から光らない</summary>光らないLEDのDinかVCC、光らないLEDの直前のDoutのどれかに問題があるはずです。各所しっかりはんだ付けし直してください。それでも光らない場合は過熱を疑いますので、LED自体を交換する必要があります。</details>
