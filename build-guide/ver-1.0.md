...
バージョンによりCaps Lockが1.5u(stepped)にも対応しています。  
...
### トラブルシューティング(1)
<details><summary>LEDがすべて光らない</summary>D73、L1、5V0、GND、GP29は問題なくはんだ付けできていますか？</details>  
...
左上のエリア、Esc以外の4キーは初期状態ではLEDの制御に使用しています。

## 書き換え
「スイッチの確認」と同じ手順で接続し、変更したいキーを選択して書き換えます。
