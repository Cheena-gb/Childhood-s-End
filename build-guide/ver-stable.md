...
販路やイベントにより販売時の内容は異なります。足りないものをそれぞれ揃えてください。
 ...
 - ゴム足  
   小4個大2個、合計6枚必要です。
 - ネジ  
   M2x3が10本、M2x7が10本必要です。
 - スペーサー  
   M2x2が10本、M2x3.5が10本必要です。
 - 作業用ピンヘッダ  
...
### プレートの組み立て
バックパネルの表からM2x7mmネジを通し、2mmスペーサーで固定します。  
ネジが露出した部分に基板を通し、3.5mmスペーサーで固定します。  
スイッチプレートを重ね、M2x3mmネジで固定します。

### ゴム足の取付け
裏側パネルにゴム足を取り付けます。  
角はちょうど文字が避けるようになっているため、そこに合わせ、文字がない部分(右側)は補助線に合わせて貼り付けてください。
大小交えて傾斜させることもできます。

### キースイッチ・キーキャップの取付け
好みのものを取り付けます。  
キースイッチをはめる際、ねじの周辺から装着すると安定します。
